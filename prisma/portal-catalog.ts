...
export const PORTAL_CATALOG: PortalSeed[] = [
  ...
  // ─── DoD ───────────────────────────────────────────────────────────
  { name: "DoD Contract Announcements", url: "https://www.defense.gov/News/Contracts", category: "DoD daily awards", agencyKind: "FEDERAL", agencyTier: "DOD", agencyName: "Department of Defense", geoScope: "FEDERAL", description: "Daily DoD contract awards >$7.5M. Useful for win/loss intelligence on competitors.", naicsFocus: "236220, 237310" },
  ...
  { name: "NAVFAC Atlantic Construction", url: "https://www.navfac.navy.mil/navfac_worldwide/atlantic.html", category: "DoD construction", agencyKind: "FEDERAL", agencyTier: "DOD", agencyName: "NAVFAC Atlantic", geoScope: "REGIONAL", geoState: "Multiple Atlantic states", description: "Naval Facilities Engineering Systems Command — Atlantic. Coastal facility construction + MILCON.", naicsFocus: "236220", setAsideFocus: "SDVOSB, 8(a), HUBZONE" },
  { name: "NAVFAC Pacific Construction", url: "https://www.navfac.navy.mil/navfac_worldwide/pacific.html", category: "DoD construction", agencyKind: "FEDERAL", agencyTier: "DOD", agencyName: "NAVFAC Pacific", geoScope: "REGIONAL", description: "NAVFAC Pacific — Hawaii, Guam, mainland west coast, Asia-Pacific.", naicsFocus: "236220" },
  ...
  { name: "DHS Procurement Opportunities", url: "https://www.dhs.gov/procurement-opportunities", category: "DHS facilities", agencyKind: "FEDERAL", agencyTier: "HOMELAND", agencyName: "Department of Homeland Security", geoScope: "FEDERAL", description: "DHS, FEMA, USCG, ICE facility construction and disaster response infrastructure.", naicsFocus: "236220, 237310" },
  { name: "DOT Contracting + Procurement", url: "https://www.transportation.gov/dot-procurement", category: "Federal transportation", agencyKind: "FEDERAL", agencyTier: "TRANSPORTATION", agencyName: "Department of Transportation", geoScope: "FEDERAL", description: "FAA, FHWA, FRA, MARAD federal-tier infrastructure. State DOT pass-throughs are listed separately.", naicsFocus: "237310, 237110" },
  { name: "HUD Building Programs", url: "https://www.hud.gov/program_offices/cpd", category: "Federal housing", agencyKind: "FEDERAL", agencyTier: "CIVILIAN", agencyName: "Department of HUD", geoScope: "FEDERAL", description: "HUD-funded housing construction + rehabilitation programs (often through state HFAs).", naicsFocus: "236116, 236117" },
  { name: "FEMA Public Assistance + Construction", url: "https://www.fema.gov/grants/public-assistance", category: "Federal disaster", agencyKind: "FEDERAL", agencyTier: "HOMELAND", agencyName: "FEMA", geoScope: "FEDERAL", description: "FEMA-funded disaster recovery construction. Surges after declared events; signal: monitor declarations.", naicsFocus: "236220, 237310" },
  ...
  { name: "NCDOT Contract Standards", url: "https://www.ncdot.gov/doh/operations/dp_chief_eng/contracts", category: "State DOT", agencyKind: "STATE", agencyTier: "TRANSPORTATION", agencyName: "North Carolina DOT", geoScope: "STATE", geoState: "NC", description: "NC DOT central + division bidding portals.", naicsFocus: "237310" },
  ...
  { name: "SC Procurement Services", url: "https://procurement.sc.gov/general/business", category: "State procurement", agencyKind: "STATE", agencyTier: "CIVILIAN", agencyName: "State of South Carolina", geoScope: "STATE", geoState: "SC", description: "South Carolina state procurement (SCEIS solicitations).", naicsFocus: "236220" },
  ...
  { name: "NC Interactive Purchasing System (IPS)", url: "https://www.ips.state.nc.us", category: "State procurement", agencyKind: "STATE", agencyTier: "CIVILIAN", agencyName: "State of North Carolina", geoScope: "STATE", geoState: "NC", description: "NC IPS statewide procurement.", naicsFocus: "236220" },
  ...
  { name: "City of Houston Strategic Procurement", url: "https://www.houstontx.gov/finance/procurement", category: "Municipal", agencyKind: "MUNICIPAL", agencyTier: "CIVILIAN", agencyName: "City of Houston, TX", geoScope: "CITY", geoCity: "Houston", geoState: "TX", description: "Houston citywide bids — large CIP program.", naicsFocus: "236220" },
  ...
  { name: "Miami-Dade County Procurement", url: "https://www.miamidade.gov/internalservices/procurement", category: "County", agencyKind: "COUNTY", agencyTier: "CIVILIAN", agencyName: "Miami-Dade County, FL", geoScope: "COUNTY", geoState: "FL", description: "Miami-Dade County construction + services procurement.", naicsFocus: "236220" },
  { name: "Cook County Office of the CPO", url: "https://www.cookcountyil.gov/agency/cook-county-procurement", category: "County", agencyKind: "COUNTY", agencyTier: "CIVILIAN", agencyName: "Cook County, IL", geoScope: "COUNTY", geoState: "IL", description: "Cook County, IL procurement (Chicago metro).", naicsFocus: "236220" },
  ...
  { name: "Maricopa County Procurement", url: "https://www.maricopa.gov/3413/Procurement-Services", category: "County", agencyKind: "COUNTY", agencyTier: "CIVILIAN", agencyName: "Maricopa County, AZ", geoScope: "COUNTY", geoState: "AZ", description: "Maricopa County, AZ procurement (Phoenix metro).", naicsFocus: "236220" },
  ...
  { name: "BidContract", url: "https://www.bidcontract.com", category: "Aggregator", agencyKind: "AGGREGATOR", agencyTier: "OTHER", geoScope: "NATIONAL", authType: "LOGIN", description: "Government bid aggregator (mainly state/local).", naicsFocus: "236220" },
